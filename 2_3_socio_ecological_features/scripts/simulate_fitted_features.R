...
identifiers = identifiers %>% dplyr::select(day, year, spot_id, camera_id, time_since_start, trip, lake, id)
...
identifiers = left_join(identifiers, spot_selection_data %>% dplyr::select(day, year, camera_id = ID, Return, spot_id))
