...
############################################
# fit models
# here, gut rule performed as well as incremental, so we extend gut, because it has
# less parameters. also, the incremental rule + fish discovery performed worse than
# gut rule + fish discovery (not implemented here for simplicity)
