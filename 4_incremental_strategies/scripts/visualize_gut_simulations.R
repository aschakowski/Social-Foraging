...
visualize_gut_simulations <- function(){
  ...
  sim_baseline = readRDS(file = "utils/data/processed_data/patch_leaving_simulations/a_sim_baseline.rds")
  sim_baseline = do.call(rbind, sim_baseline)
  sim_time_wo_catch = readRDS(file = "utils/data/processed_data/patch_leaving_simulations/b_sim_time_wo_catch.rds")
  sim_time_wo_catch = do.call(rbind, sim_time_wo_catch)
  sim_patch_discovery = readRDS(file = "utils/data/processed_data/patch_leaving_simulations/c_sim_patch_discovery.rds")
  sim_patch_discovery = do.call(rbind, sim_patch_discovery)
  sim_global_local = readRDS(file = "utils/data/processed_data/patch_leaving_simulations/d_sim_global_local.rds")
  sim_global_local = do.call(rbind, sim_global_local)
  sim_spatial_features = readRDS(file = "utils/data/processed_data/patch_leaving_simulations/e_sim_spatial_features.rds")
  ...
  for (model in 1:5){
    ...
    plots[[model]] = ggplot(data = plot_data, aes(x = gut_data_mean, y = gut_sim_mean)) + 
      ...
      geom_errorbar(aes(ymin = lowery, ymax = uppery), alpha = .05) + 
  ...
  ggsave(panel_spot_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_spot_predictions.svg", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_spot_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_spot_predictions.pdf", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_spot_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_spot_predictions.tiff", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  
  ggsave(panel_trip_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_trip_predictions.png", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_trip_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_trip_predictions.svg", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_trip_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_trip_predictions.pdf", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_trip_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_trip_predictions.tiff", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  
  ggsave(panel_id_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_id_predictions.png", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_id_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_id_predictions.svg", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_id_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_id_predictions.pdf", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_id_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_id_predictions.tiff", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  
  ggsave(panel_lake_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_lake_predictions.png", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_lake_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_lake_predictions.svg", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_lake_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_lake_predictions.pdf", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_lake_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_lake_predictions.tiff", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ...
  ggsave(panel_delta_gut_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_delta_gut_predictions.png", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_delta_gut_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_delta_gut_predictions.pdf", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_delta_gut_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_delta_gut_predictions.svg", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
  ggsave(panel_delta_gut_predictions, file = "4_incremental_strategies/output/panel_patch_leaving_delta_gut_predictions.tiff", 
         width = 18, height = 13, bg = "white", dpi = 600, units = "cm")
}
################################################################################
# END
