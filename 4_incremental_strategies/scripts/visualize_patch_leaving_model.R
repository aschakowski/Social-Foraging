...
stan_data = readRDS(file = "utils/data/raw_data/stan_data_patch_leaving.rds")
...
comparison = readRDS(file = "utils/data/processed_data/model_fit/patch_leaving_models/comparison/comparison.rds")
