...
social_distances =  readRDS(file = "utils/data/raw_data/social_distance_matrix.rds")
...
# scale ID effects
#id_effects$scaled_v_id = ifelse(id_effects$parameter == 1, id_effects$v_id * scale_features$sd_social,
#                            ifelse(id_effects$parameter == 2, id_effects$v_id *scale_features$sd_roughness,
#                                ifelse(id_effects$parameter == 3, id_effects$v_id * scale_features$sd_success,
#                                       ifelse(id_effects$parameter == 4, id_effects$v_id * scale_features$sd_loss,
#                                              ifelse(id_effects$parameter == 5, id_effects$v_id * scale_features$sd_locality,
#                                                     ifelse(id_effects$parameter == 6, id_effects$v_id * scale_features$sd_locality_time,
#                                                            ifelse(id_effects$parameter == 7, id_effects$v_id * scale_features$sd_social_loss,
#                                                                   id_effects$v_id * scale_features$sd_social_success)))))))
...
# standardize lake estimates
#lake_estimates$scaled_v_lake = ifelse(lake_estimates$parameter == 1, lake_estimates$v_lake*scale_features$sd_social,
#                                      ifelse(lake_estimates$parameter == 2, lake_estimates$v_lake*scale_features$sd_roughness, 
#                                             ifelse(lake_estimates$parameter == 3, lake_estimates$v_lake*scale_features$sd_success,
#                                                    ifelse(lake_estimates$parameter == 4, lake_estimates$v_lake*scale_features$sd_loss,
#                                                           ifelse(lake_estimates$parameter == 5, lake_estimates$v_lake*scale_features$sd_locality,
#                                                                  ifelse(lake_estimates$parameter == 6, lake_estimates$v_lake*scale_features$sd_locality_time,
#                                                                         ifelse(lake_estimates$parameter == 7, lake_estimates$v_lake*scale_features$sd_social_loss,lake_estimates$v_lake*scale_features$sd_social_success)))))))
...
var_roughness = fitted_features %>% 
  ...
  dplyr::summarize(var = sd(roughness_feature))
...
# create key linking unique participant id to model estimates (recreate prepare stan data)
# spatial model
identifiers = readRDS(file = "utils/data/raw_data/identifiers_patch_leaving.rds")
